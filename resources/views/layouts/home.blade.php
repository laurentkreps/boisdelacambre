...
Hiver comme été, il fait bon s'y arrêter d'autant plus que, fait rare dans un club de sport, la cuisine est de grande qualité. N'hésitez pas à visiter la partie "Restaurant" de ce site pour en savoir plus...</div>
  ...
  <p>&nbsp;<p/>
    Liens rapides:
      <ul class="list-group">
        <li class="list-group-item"><a href="{{ url('/restaurant#photos') }}" class="liens_shortcut">Photos</a></li>
        <li class="list-group-item list-group-item-success"><a href="{{ url('/restaurant#carte') }}" class="liens_shortcut">La carte</a></li>
        <li class="list-group-item"><a href="{{ url('/restaurant#banquets') }}" class="liens_shortcut">Les menus</a></li>
        <li class="list-group-item list-group-item-success"><a href="{{ url('/restaurant#banquets') }}" class="liens_shortcut">Réservations</a></li>
      </ul>
        </div>
      </div>
     <div>
...
<p> Liens rapides:</p>
      <ul>
        <li class="list-group-item"><a href="{{ url('/tennis#photos') }}" class="liens_shortcut">Photos</a></li>
        <li class="list-group-item list-group-item-success"><a href="{{ url('/tennis') }}" class="liens_shortcut">Les terrains</a></li>
        <li class="list-group-item"><a href="{{ url('/reservations') }}" class="liens_shortcut">Réservations (explications)</a></li>
        <li class="list-group-item"><a href="{{ url('https://ballejaune.com/club/boisdelacambre') }}" class="liens_shortcut">Réservations (plateforme)</a></li>
        <li class="list-group-item list-group-item-success"><a href="{{ url('/ecole') }}" class="liens_shortcut">L'école de tennis</a></li>
        <li class="list-group-item"><a href="{{ url('/ecole#cours') }}" class="liens_shortcut">Les cours</a></li>
        <li class="list-group-item list-group-item-success"><a href="{{ url('/ecole#stages') }}" class="liens_shortcut">Les stages</a></li>
        <li class="list-group-item"><a href="{{ url('/inscriptions') }}" class="liens_shortcut">Inscriptions</a></li>
      </ul>
        </div>
        <div>
